...
from risk_tool.engine.io_excel import ExcelImporter, ExcelExporter, ExcelTemplateGenerator
...
class TestExcelIO:
    ...
    def test_excel_export(self, sample_excel_data):
        ...
        expected_sheets = ['Summary', 'Total_Cost_Statistics', 'WBS_Cost_Statistics', 'Risk_Statistics']
    ...
    def test_excel_template_generation(self):
        ...
        expected_sheets = ['Instructions', 'Project_Info', 'WBS_Items', 'Risks', 'Correlations']
...
class TestCSVIO:
    ...
    def test_csv_import_project(self, sample_csv_files):
        ...
        project_data = importer.import_project(
            str(sample_csv_files['project']),
            str(sample_csv_files['wbs'])
        )
    ...
    def test_csv_template_generation(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            expected_files = ['project_template.csv', 'wbs_template.csv', 'risks_template.csv']
            for filename in expected_files:
...
class TestJSONIO:
    ...
    def test_json_import_correlations(self, sample_json_data):
        ...
        importer = JSONImporter()
        correlations_data = importer.import_correlations(str(sample_json_data['correlations']))
...
class TestIOErrorHandling:
    ...
    def test_csv_missing_required_columns(self):
        ...
        wbs_df = pd.DataFrame([{
            'id': 'test', 'name': 'Test', 'base_cost': 100000,
            'dist_type': 'normal', 'mean': 100000, 'stdev': 10000
        }])
...
class TestIOIntegration:
    ...
    def test_excel_to_json_roundtrip(self):
        ...
        project_data, risks_data, correlations_data = excel_importer.import_project(str(excel_path))
        ...
        assert imported_project_data['project_info']['name'] == project_data['project_info']['name']
