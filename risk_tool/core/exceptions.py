...
class ValidationError(RiskModelingError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        recovery_suggestions = kwargs.get(
...
class FileFormatError(IOError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        context = kwargs.get("context", {})
        context.update(
            {"expected_format": expected_format, "detected_format": detected_format}
        )
...
class ConfigurationError(RiskModelingError):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        context = kwargs.get("context", {})
        context.update({"config_key": config_key, "config_value": config_value})
...
class MemoryError(PerformanceError):
    ...
    def __init__(self, message: str, memory_used: float, memory_limit: float, **kwargs):
        recovery_suggestions = [
...
class TimeoutError(PerformanceError):
    ...
    def __init__(
        self, message: str, elapsed_time: float, timeout_limit: float, **kwargs
    ):
        recovery_suggestions = [
...
def handle_exception(
    ...
    if isinstance(exception, RiskModelingError):
        ...
        risk_error = RiskModelingError(str(exception), context=context, cause=exception)
